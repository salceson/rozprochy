...
/**
* edu/sr/generated/example2/AFactoryPOA.java .
...
public abstract class AFactoryPOA extends org.omg.PortableServer.Servant
 implements edu.sr.generated.example2.AFactoryOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    switch (__method.intValue ())
    {
       case 0:  // example2/AFactory/create_item
       {
         try {
           ...
           edu.sr.generated.example2.Item $result = null;
           $result = this.create_item (name, type);
           out = $rh.createReply();
           edu.sr.generated.example2.ItemHelper.write (out, $result);
         } catch (edu.sr.generated.example2.ItemAlreadyExists $ex) {
           out = $rh.createExceptionReply ();
           edu.sr.generated.example2.ItemAlreadyExistsHelper.write (out, $ex);
         }
         break;
       }
       ...
       case 1:  // example2/AFactory/take_item
       {
         try {
           ...
           out = $rh.createReply();
           edu.sr.generated.example2.ItemHelper.write (out, $result);
         } catch (edu.sr.generated.example2.ItemNotExists $ex) {
           out = $rh.createExceptionReply ();
           edu.sr.generated.example2.ItemNotExistsHelper.write (out, $ex);
         } catch (edu.sr.generated.example2.ItemBusy $ex) {
           out = $rh.createExceptionReply ();
           edu.sr.generated.example2.ItemBusyHelper.write (out, $ex);
         }
         break;
       }
