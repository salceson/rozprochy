...
public class Client 
{
    ...
    public int run(String[] args)
    {
    	...
    	ObjectPrx obj = communicator.propertyToProxy("SRadapter.Proxy"); //TODO - config file
        ...
        do
        {
            try
            {
                ...
                if(line.equals("t"))
                {
                    twoway.sayHello(delay, 2);
                }
                else if(line.equals("o"))
                {
                    oneway.sayHello(delay, 2);
                }
                else if(line.equals("O"))
                {
                    batchOneway.sayHello(delay, 2);
                }
                ...
                else if(line.equals("D"))
                {
                    ...
                    {
                        batchDatagram.sayHello(delay, 2);
                    }
                }
